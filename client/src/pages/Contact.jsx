      ...
      <div className="max-w-5xl mx-auto relative z-10 space-y-32">
        ...
        >
           <div className="w-48 h-48 md:w-64 md:h-64 rounded-full overflow-hidden border-4 border-white/10 shadow-2xl shrink-0 relative group">
              ...
              <img 
                src="https://images.unsplash.com/photo-1531891437562-4301cf35b7e4?auto=format&fit=crop&q=80&w=600" 
                alt="Rajdeep Ray"
           ...
           <div className="text-center md:text-left space-y-4">
              ...
              <div className="pt-4 flex flex-wrap gap-3 justify-center md:justify-start">
                 <span className="bg-white/5 border border-white/10 px-4 py-2 rounded-full text-sm font-semibold text-white/80">BTech Student</span>
                 <span className="bg-white/5 border border-white/10 px-4 py-2 rounded-full text-sm font-semibold text-white/80">Liverpool FC Supporter</span>
